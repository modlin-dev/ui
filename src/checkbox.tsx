		...
		<>
			...
			<button
				...
				className={cn(
					...
					"bg-background inset-ring inset-ring-muted-foreground peer-checked:bg-primary peer-checked:inset-ring-0 focus-visible:ring-4 focus-visible:ring-primary/10 disabled:inset-ring-border peer-checked:disabled:bg-primary/50"
