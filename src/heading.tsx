...
export default function Heading(props: Readonly<HeadingProps>) {
	return <h1 className={cn("scroll-m-20 text-center text-4xl font-extrabold tracking-tight text-balance", props.className)}>{props.children}</h1>
}
...
export function Heading2(props: Readonly<HeadingProps>) {
	return <h2 className={cn("scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight first:mt-0", props.className)}>{props.children}</h2>
}
...
export function Heading5(props: Readonly<HeadingProps>) {
	return <h5 className={cn("scroll-m-20 text-lg font-medium", props.className)}>{props.children}</h5>
}
export function Heading6(props: Readonly<HeadingProps>) {
	return <h6 className={cn("scroll-m-20 text-base font-medium first:leading-none first:mb-1 last:mb-0", props.className)}>{props.children}</h6>
}
